    ...
    private static TelefonskiBroj unesiBrojTelefona() {
        ...
        switch (tip) {
            ...
            case 3:
                ...
                return new MedunarodniBroj(kod, medBr);
        }
        return null;
    }

    private static void popuniPodatke() {
        imenik.dodaj("Tarik", new FiksniBroj(Grad.Sarajevo, "123-123"));
        imenik.dodaj("Adnan", new FiksniBroj(Grad.Mostar, "432-143"));
        imenik.dodaj("Adi", new FiksniBroj(Grad.Zenica, "324-867"));
        imenik.dodaj("Amir", new FiksniBroj(Grad.Tuzla, "098-423"));
    }
}
